...
export interface PodcastsAppIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
}

export const PodcastsAppIcon: FC<PodcastsAppIconProps> = ({
  size = 24,
  color = "currentColor",
  className,
  ...props
}) => (
  // biome-ignore lint/a11y/noSvgWithoutTitle: decorative icon; labelled by surrounding context or aria-hidden
  <svg
